...
interface CustomNavigationBarProps {
  ...
  route: RouteProp<any, any>; // Adjust the types according to your navigation stack
  options: any; // You may want to provide a specific type for this based on your use case
  back?: boolean;
}
